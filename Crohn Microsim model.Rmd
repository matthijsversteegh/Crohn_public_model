...
date: "First draft: January 7th 2025. Post TECH-VER checklist update: April 15th 2025"
...
prices     <- "list"  #"list" for list prices or "discounted" for prices based on Vektis declaration data (including discounts) (not publicly available). All 2023 Euros.
...
#load(here::here("Input", "df_tp_RWD.RData")) #deprecated after TECH-VER checklist
load(here::here("Input", "df_tp_RWD_update20250414.RData"))
...
n_t                             <- as.integer((max_age-18)*(52/cl_wk))    # time horizon in cl_wk week-cycles
n_cycles                        <- n_t                                    # number of cycles
n_i                             <- 30000                                  # number of simulated individuals # > 10.000 recommended for base case
v_n                             <- c("ACT", "REM", "REM_ps", "D")         # the model health states names (active disease, remission, remission post surgery, death)
...
df_mort$p_mort[109]             <- 1 #close the life table, no survival beyond this age
...
MicroSim <- function(l_params_all, n_i, df_X, TRT1 = TRT1, TRT2 = TRT2, TRT3 = TRT3, TRT4 = TRT4, TRT5 = TRT5, seed = 1) {
  ...
  for (t in 1:n_t) {
   ...
   df_X$Line <- ifelse(m_M[, t + 1] =="D", 999,
                 ...
                 ifelse(m_M[, t + 1] == "REM" & df_X$disc == 1 & df_X$Line < 5, df_X$Line + 1,  
                 ifelse(m_M[, t + 1] == "REM" & df_X$disc == 1 & df_X$Line == 5, 555, df_X$Line)))))))) #discontinuation switch
